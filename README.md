...
|:----------------:|:-----|:-----------|:-------|
| :heavy_check_mark: :wrench: | [`require-plural-paths`][rule-plural-paths-url] | Require plural nouns in API paths. | [In Progress](https://github.com/gregswindle/eslint-plugin-swagger-tools/issues/5) |
