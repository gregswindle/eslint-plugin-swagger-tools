...
`eslint-plugin-swagger-tools` is a work in progress. The product backlog has lots of lonely `rules` waiting for nice contributors like you. :kissing_heart: If you're interested, please:
...
|  | [`operation-body`](https://github.com/gregswindle/eslint-plugin-swagger-tools/issues/new?title=feat%28operation-body%29%3A%20Each%20operation%20should%20have%20...&labels[]=ESLint%3A%20Rule&labels[]=Status%3A%20Review%20Needed&labels[]=Type%3A%20Feature) | Each operation should have only one parameter of type `body`  |
...
|  | [`plural-paths`](https://github.com/gregswindle/eslint-plugin-swagger-tools/issues/new?title=feat%28plural-paths%29%3A%20Require%20API%20paths%20to%20use%20pl...&labels[]=ESLint%3A%20Rule&labels[]=Status%3A%20Review%20Needed&labels[]=Type%3A%20Feature) | Require API paths to use plural nouns for all resources. |
...
Contributions have a beginning, middle, and end; their stories are told through issues and pull requests.
