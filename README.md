...
|  | [`require-plural-paths`](https://github.com/gregswindle/eslint-plugin-swagger-tools/issues/5) | Require plural nouns in API paths | [#5](https://github.com/gregswindle/eslint-plugin-swagger-tools/issues/5) In Progress |
